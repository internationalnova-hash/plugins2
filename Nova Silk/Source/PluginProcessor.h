...
class NovaSilkAudioProcessor : public juce::AudioProcessor
{
public:
    static constexpr int spectrumBins = 96;

    NovaSilkAudioProcessor();
    ~NovaSilkAudioProcessor() override;
...
private:
    ...
    std::array<float, smoothingBandCount> bandResonanceDb {};
    std::array<float, smoothingBandCount> bandRawReductionDb {};
    std::array<float, smoothingBandCount> bandSmoothedReductionDb {};
    std::array<float, smoothingBandCount> bandTimedReductionDb {};
    std::array<float, smoothingBandCount> lastBandReductionDb {};
